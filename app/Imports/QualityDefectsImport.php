...
class QualityDefectsImport implements ToCollection
{
    public function collection(Collection $collection)
    {
        ...
        $collection->push(['effective_date' => $collection[0]['effective_date'], 'group' => '其他', 'title' => '其他', 'category' => '其他', 'description' => '其他', 'deduct_point' => 0, 'report_description' => '其他']);
        ...
        foreach ($collection as $item) {
            $defect = new \App\Models\QualityDefect();
            $defect->fill($item);
            $defect->save();
        }
    }
