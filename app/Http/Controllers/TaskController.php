...
class TaskController extends Controller
{
    ...
    public function edit(Task $task)
    {
        ...
        return view('backend.tasks.edit', compact('task', 'title', 'meals', 'users', 'projects'));
    }
    ...
    public function outerReport(Task $task)
    {
        ...
        // 重新排序 defects.defect.gruup = 重大缺失 排第一個, is_suggestion = 1 和 is_repeat = 1 和 is_not_reach_deduct_standard = 1 和 is_ignore = 1 排最後
