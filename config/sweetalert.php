...
return [
    ...
    */
    ...
    'timer' => env('SWEET_ALERT_TIMER', 180000),
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', '確認刪除!'),
    ...
    'confirm_delete_cancel_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CANCEL_BUTTON_TEXT', '取消'),
