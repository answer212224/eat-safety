<x-base-layout :scrollspy="false">
    ...
    @if ($taskHasDefect->task->category == '清潔檢查')
        <form action="{{ route('task-clear-defect-update', ['taskHasDefect' => $taskHasDefect]) }}" method="post">
        @else
            ...
            <div class="widget-content widget-content-area blog-create-section">
                <div class="row">
                    ...
                    <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                        ...
                        @if ($taskHasDefect->task->category == '清潔檢查')
                            <a href="{{ route('task-clear-defect-owner', ['task' => $taskHasDefect->task->id]) }}"
                                class="btn btn-dark w-100 my-3">上一頁</a>
                        @else
                            <a href="{{ route('task-defect-owner', ['task' => $taskHasDefect->task->id]) }}"
                                class="btn btn-dark w-100 my-3">上一頁</a>
                        @endif
                    </div>
                </div>
