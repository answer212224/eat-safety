                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <div id="blog-description">
                                        Aliquam leo elit, semper sed diam non, efficitur semper mi. Sed pulvinar velit
                                        massa, nec ornare arcu laoreet non. Quisque dignissim lectus eget lectus
                                        pulvinar
                                        imperdiet. Aliquam dictum porttitor laoreet. Duis ac tortor non sem vestibulum
                                        interdum in quis dui. Pellentesque nec augue eleifend, convallis tortor ac,
                                        posuere
                                        turpis. Nulla commodo euismod felis vitae eleifend. Morbi cursus maximus mauris
                                        ac
                                        lacinia. Nullam tellus dolor, sodales vitae nunc id, luctus lacinia leo. Sed id
                                        urna
                                        venenatis lacus lobortis ullamcorper nec dignissim odio.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-xxl-12 mb-4">
                                    <input type="text" class="form-control" id="post-meta-title"
                                        placeholder="Post Title" value="Elegant and useful Admin Templates">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12 col-md-12 mb-4">
                                    ...
                                    <input id="category" name="category"
                                        value="Themeforest, Cork Admin, Dashboard, Vue, Laravel"
                                        placeholder="Choose...">
                                </div>
                                <div class="col-xxl-12 col-md-12 mb-4">
