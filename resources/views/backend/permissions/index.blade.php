                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('role-destroy', ['role' => $role]) }}"
                                    class="badge badge-light-danger" data-confirm-delete="true">刪除</a>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('permission-destroy', ['permission' => $permission]) }}"
                                    class="badge badge-light-danger" data-confirm-delete="true">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
